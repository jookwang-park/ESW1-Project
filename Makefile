...
app:
	arm-none-linux-gnueabi-gcc -o daemon.out ./daemon/main.c ./daemon/util.c ./daemon/sprinkler.c motor_api.c farm_api.c led_api.c speaker_api.c spi_api.c dht_api.c -lpthread -L daemon/lib -lpaho-mqtt3c
test:
