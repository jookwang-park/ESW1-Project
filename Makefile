...
obj-m   := farm_mod.o
farm_mod-objs := farm.o motor.o led.o speaker.o spi.o
...
test:
	arm-none-linux-gnueabi-gcc -o test.out test.c motor_api.c farm_api.c led_api.c speaker_api.c spi_api.c -lpthread
clean:
